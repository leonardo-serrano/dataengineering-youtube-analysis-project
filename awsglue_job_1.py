...
# AWS Glue pyspark job: de-on-youtube-cleansed-csv-to-parquet
...
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "de_youtube_raw", table_name = "raw_statistics", transformation_ctx = "datasource0", push_down_predicate = predicate_pushdown) ## MODIFIED
...
datasink4 = glueContext.write_dynamic_frame.from_options(frame = dropnullfields3, connection_type = "s3", connection_options = {"path": "s3://de-on-youtube-cleaned-saeast1-dev-x/youtube/raw_statistics/", "partition_keys": ["region"]}, format = "parquet", transformation_ctx = "datasink4")
