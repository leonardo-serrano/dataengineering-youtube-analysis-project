...
1. Amazon S3: An object storage service that provides manufacturing scalability, data availability, security, and performance.
...
6. AWS Athena: An interactive query service for S3 in which there is no need to load data it stays in S3.
